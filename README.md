...
To use this app, first clone from GitHub via 'git clone git@github.com:jffernan/my-react-redux-calculator.git' at your terminal, 'cd' to the new directory, then run ‘npm install’, and last, run ‘npm start' to launch your http server.
